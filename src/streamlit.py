...
@st.cache_resource
def retrieve_model(run_id: str, model_uri: str, model_name: str):
    """
    Helper function to retrieve trained model from MLFlow as 
    ...
    """
    return xray_clf.modeling.model.retrieve_model(run_id, model_uri, model_name)
